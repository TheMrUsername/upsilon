...
public abstract class UpsilonLexerBase : Lexer
{
    public UpsilonLexerBase(ICharStream input)
        : base(input)
    {
        _input = input;
    }

    public UpsilonLexerBase(ICharStream input, TextWriter output, TextWriter errorOutput)
    ...
    protected void OnColon()
    {
        ...
        if (interpolatedStringLevel > 0)
        {
            ...
            {
                this.Mode(UpsilonLexer.INTERPOLATION_FORMAT);
            }
        }
    }
