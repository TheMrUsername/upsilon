...
public abstract class UpsilonParserBase : Parser
{
    protected UpsilonParserBase(ITokenStream input)
        : base(input)
    {
    }

    protected UpsilonParserBase(ITokenStream input, TextWriter output, TextWriter errorOutput)
